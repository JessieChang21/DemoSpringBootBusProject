...
function insertTime(){
	var theSeleH = $('#idSelectHour');
 	...
 	var op="<option value='' selected='selected'>--</option>";
 	for(var i=0; i<24; i++){
 		if(i>9){
 	...
 	var op2="<option value='' selected='selected'>--</option>";
                            ...
                            <form:form action="addTempBus.controller" method="post" modelAttribute="tempBus">           
                                <table class="table table-bordered" id="showroutes" width="100%" cellspacing="0">
								      ...
								      <tr>
								         ...
								         <td><form:input path="totalSeats" value="40"/><span  style='color:red; font-size:8px;'>${errors.totalSeatsE}</span></td>
								      </tr>
								      <tr>
								...
								<a href='<c:url value='http://localhost:8081/busTimes/findbustimeShow.controller?rid=${rid}' />' class='btn btn-primary'>上一頁</a>
