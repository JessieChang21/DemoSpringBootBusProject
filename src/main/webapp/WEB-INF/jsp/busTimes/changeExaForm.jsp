                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form:form action="http://localhost:8081/busTimes/toChangeBus.controller" method="post" modelAttribute="tempBus">
								      ...
								      <tr align='center'>
								      	 <td colspan="2">
									      	...
									      	<form:hidden path="travelTime" value = "${tempBus.travelTime}"/>
									      	 ...
									      	 <input type="submit" name="update" value="申請變更" class="btn btn-warning" onclick="return(confirm('是否確認要送出變更申請？'))">
									         &emsp;&emsp;&emsp;<input type="submit" name="delete" value="申請刪除" class="btn btn-danger" onclick="return(confirm('是否確認要送出刪除申請？'))">
								         </td>
								      </tr>
                                </table>
                            </form:form>
