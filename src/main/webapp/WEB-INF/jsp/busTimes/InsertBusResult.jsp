                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" align='center'>
							...
							<c:if test="${tempBus.toExamine==3||tempBus.toExamine==43||tempBus.toExamine==53}">已通過申請</c:if>
							<c:if test="${tempBus.toExamine==2||tempBus.toExamine==42||tempBus.toExamine==52}">已退回申請</c:if>
							<c:if test="${tempBus.toExamine==1||tempBus.toExamine==4||tempBus.toExamine==5}">已送出申請</c:if>
                            ...
                            <div class="table-responsive">
                               <table class = "table table-bordered" id="showTable">
                                ...
                                <div>
                                	...
                                	<div>
	                                	<a href="<c:url value='http://localhost:8081/busTimes/tempbustimemain.controller?tEx=9' />" class="btn btn-primary">進入申請紀錄</a>
										<a href="<c:url value='http://localhost:8081/busTimes/findbustimeShow.controller?rid=${tempBus.routeId}' />" class="btn btn-primary">返回車次路線</a>
									</div>
