        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">新增路線</h1>
                    
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4" id='showAll'>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="insertRoutesInfo.controller" method="post" modelAttribute="newRoute">           
                                
                                <table class="table table-bordered" id="showroutes" width="100%" cellspacing="0">
                                    <tr>
										<td><label>路線編號:</label></td>
										<td><input type="hidden" name="routeId" value='${newRoute.routeId}'/>${newRoute.routeId}</td>
									</tr>
									<tr>
								        <td><label >路線名稱:</label></td>
								        <td><input name="tripName" id="tripName"><span>${errors.tripNameE}</span></td>
								    </tr>
								    <tr>
								        <td><label>地區:</label></td>
								        <td>
								        <select id='areaS' name='area'></select>
								        <span>${errors.areaE}</span>
								        </td>
								    </tr>
								    <tr>
								        <td><label>方向:</label></td>
								        <td><select name="direction" id='direction'>
								        	<option value="9" label="請選擇方向" id='op9' />
								        	<option value="0" label="去程" id='op0'/>
								        	<option value="1" label="返程" id='op1'/>
								        </select><span>${errors.dirE}</span></td>
								    </tr>
								    <tr align='center'><td colspan="2">
								    <input type="submit" value='新增路線' onclick="return(confirm('是否確認送出？'))" class="btn btn-primary">
